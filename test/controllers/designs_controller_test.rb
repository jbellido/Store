...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { comment: @design.comment, design_date: @design.design_date, image_url: @design.image_url, ispublic: @design.ispublic, name: @design.name }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { comment: @design.comment, design_date: @design.design_date, image_url: @design.image_url, ispublic: @design.ispublic, name: @design.name }
    assert_redirected_to design_path(assigns(:design))
  end
