...
class RankingsControllerTest < ActionController::TestCase
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post :create, ranking: { comment: @ranking.comment, ranking_date: @ranking.ranking_date, score: @ranking.score }
    end
  ...
  test "should update ranking" do
    patch :update, id: @ranking, ranking: { comment: @ranking.comment, ranking_date: @ranking.ranking_date, score: @ranking.score }
    assert_redirected_to ranking_path(assigns(:ranking))
  end
